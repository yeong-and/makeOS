...
#define	MAXSECTION		16	/* 1개의 .obj파일당의 최대 섹션수 */

#define NO_WARN			1	/* 경고지우기용의 무용코드의 유효화 */
...
{
	/* align이 2로 되어 있는지는 귀찮아서 확인하고 있지 않다 */
	int i; 
	if ((i = align) >= 1) {
		align = 1;
		while (i >>= 1);
