...
static UCHAR *convmain(UCHAR *src0, UCHAR *src1, UCHAR *dest0, UCHAR *dest1, struct STR_FLAGS flags)
{
	...
	/* 알고리즘：토큰으로 단락짓는다. 그리고 시작되는 토큰을 등록 */
	r = src0;
